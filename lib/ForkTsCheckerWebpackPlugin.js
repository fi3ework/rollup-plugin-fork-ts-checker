...
var CancellationToken_1 = require("fork-ts-checker-webpack-plugin/lib/CancellationToken");
var formatter_1 = require("fork-ts-checker-webpack-plugin/lib/formatter");
var FsHelper_1 = require("fork-ts-checker-webpack-plugin/lib/FsHelper");
var hooks_1 = require("fork-ts-checker-webpack-plugin/lib/hooks");
var RpcTypes_1 = require("fork-ts-checker-webpack-plugin/lib/RpcTypes");
var issue_1 = require("fork-ts-checker-webpack-plugin/lib/issue");
/**
...
var ForkTsCheckerWebpackPlugin = /** @class */ (function () {
    function ForkTsCheckerWebpackPlugin(options) {
        ...
        this.options = function (options, pluginContext) {
            console.log('🐶', 'options');
            _this.apply('');
            _this.compiler = { options: options };
            _this.isWatching = !!options.watch;
        };
        // NOTE: compiler.hooks.compile -> buildStart()
        this.buildStart = function (options) {
            console.log('🐶 buildStart hook');
            var forkTsCheckerHooks = ForkTsCheckerWebpackPlugin.getCompilerHooks(_this.compiler);
        ...
        // NOTE: FTC
        this.generateBundle = function (pluginContext) {
            ...
            return new Promise(function (resolve, reject) {
                var emit = function (compilation, callback) {
                    ...
                    _this.emitCallback = _this.createEmitCallback(pluginContext, resolve);
                    if (_this.checkDone) {
                        _this.emitCallback();
                    }
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ForkTsCheckerWebpackPlugin.getCompilerHooks = function (context) {
        // TODO: no type check here?
        return hooks_1.getForkTsCheckerWebpackPluginHooks(context);
    };
    ForkTsCheckerWebpackPlugin.prototype.validateTypeScript = function (options) {
        ...
        var compilerOptions = typeof options.compilerOptions === 'object' ? options.compilerOptions : {};
    ...
    ForkTsCheckerWebpackPlugin.prototype.spawnService = function () {
        var _this = this;
        var env = __assign(__assign({}, process.env), { TYPESCRIPT_PATH: this.typescriptPath, TSCONFIG: this.tsconfigPath, COMPILER_OPTIONS: JSON.stringify(this.compilerOptions), 
            // CONTEXT: this.compiler.options.context,
            ESLINT: String(this.eslint), ESLINT_OPTIONS: JSON.stringify(this.eslintOptions), MEMORY_LIMIT: String(this.memoryLimit), CHECK_SYNTACTIC_ERRORS: String(this.checkSyntacticErrors), USE_INCREMENTAL_API: String(this.useTypescriptIncrementalApi === true), VUE: JSON.stringify(this.vue) });
        ...
        this.service = childProcess.fork(require.resolve('fork-ts-checker-webpack-plugin/lib/service.js'), 
    ...
    ForkTsCheckerWebpackPlugin.prototype.createEmitCallback = function (pluginContext, callback) {
...
//# sourceMappingURL=ForkTsCheckerWebpackPlugin.js.map